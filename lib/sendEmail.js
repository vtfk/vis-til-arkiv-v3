...
module.exports = {
  ...
  emailServiceUnavailable: (emailAddress, filename) => {
    const htmlText = '<em>(Dette er en automatisk generert e-post, du kan ikke svare på denne)</em> <br><br> Hei! <br><br> Arkiveringsløsningen VIS til Arkiv (Public 360), er midlertidig skrudd av grunnet en endring Visma har gjort med malene sine. Sak er meldt til Visma. Ditt dokument, <em>' + filename + '</em>, vil <strong>ikke</strong> bli arkivert - løsningen vil bli satt i drift igjen så snart Visma har fikset problemet. <br><br>---<br> Mvh BDK-TEK'
    const mailOptions = {
      from: 'ikkeSvar@vtfk.no',
      to: emailAddress,
      subject: 'VIS til Arkiv - løsningen er midlertidig skrudd av grunnet en mal-feil hos Visma',
      html: htmlText
    }
